...
%\usepackage{lmodern}
\usepackage{cmbright}
\usepackage{enumitem}  				% Paket für benutzerdefinierte Aufzählungen
...
\hypersetup{
	...
	pdftitle =  {Wissenschaftliche Arbeit},
	pdfsubject = {Dichte- und Schwindungsauswertung von 316L gedruckten Teilen im FDM-Prozess},
 	pdfkeywords = {3D-Druck, Filament, Metall, Dichte, Zugversuch, Schwindung},
